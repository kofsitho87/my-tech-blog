...
> **Version note:** 이 글은 2026년 8월 7일과 현재 프로젝트의 `livekit-agents>=1.6.8` 구성을 기준으로 작성했습니다. LiveKit의 `AgentTask`와 `TaskGroup` API는 빠르게 변하고 있으므로 새로 적용할 때는 현재 문서를 다시 확인해야 합니다.
